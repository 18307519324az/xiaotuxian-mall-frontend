<template>
  <div class="goods-tabs">
    ...
    <!-- 动态组件component组件 is属性用来决定component动态组件渲染为那个组件，组件的名称  -->
...
export default {
  ...
  setup() {
    ...
    // Use injected activeGoodsTab so goods-sales can trigger tab switching
    const activeName = inject("activeGoodsTab", ref("detail"));
    const clickTab = (name) => {
